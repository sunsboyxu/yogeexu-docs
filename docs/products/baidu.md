...
- [](http://ai.baidu.com/docs#/QuickStart-Review/top)
- [百度API-SDK](https://ai.baidu.com/sdk#bfr)
- [百度文字识别（OCR）服务](https://ai.baidu.com/docs#/OCR-API/top)

## 图像识别

- [图像识别](http://ai.baidu.com/tech/imagerecognition)
