...
- [vue3 新版中文文档](https://staging-cn.vuejs.org/)
- [Vue 3 迁移指南](https://v3-migration.vuejs.org/)
- [Vue3 Api](https://cn.vuejs.org/api/)
- [了解 Typescript 在 vue3 项目中的优势](https://www.bilibili.com/video/BV1St4y1A71B)

## vue3 学习

- [Vue3 + TypeScript + Pinia 搭建一套企业级的开发脚手架](https://www.jianshu.com/p/063188d494ed)
- [vite+Vue3+ts 搭建通用后台管理系统](https://mp.weixin.qq.com/s/6xsfxH70VjPtbwJWZ7mmbg)
...
- [基于 Vue3+TypeScript+ Vue-Cli4.0 构建手机端模板脚手架](https://www.jianshu.com/p/adb0983830f6)
...
- [vue3+ts 项目：.eslintrc.js](https://www.jianshu.com/p/b10273d4293d)
...
<Tabs>
<TabItem label="命令创建项目" value='cli'>
...
<TabItem label="可视化创建项目" value='ui'>
