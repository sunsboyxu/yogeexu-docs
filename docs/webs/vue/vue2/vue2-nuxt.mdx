...
- [在 Nuxt.js 中安装 Tailwind CSS](https://www.tailwindcss.cn/docs/guides/nuxtjs)
...
```bash
npm install @nuxtjs/tailwindcss tailwindcss@latest postcss@latest autoprefixer@latest -D
```
